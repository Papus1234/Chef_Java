...
public class Sort {
	 ...
	 public static Lista bubble(Lista<Ingrediente> lista){
	 ...
	 public static Lista quick(Lista<Ingrediente> lista){
 ...
 private static Lista quickSort(Lista<Ingrediente> lista,int lowerIndex, int higherIndex){
     int i=lowerIndex;
     int j=higherIndex;
 ...
 public static void shell(Lista<Ingrediente> v) {
